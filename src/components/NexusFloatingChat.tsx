    ...
    <div className="nexus-floating-chat" style={{ bottom: bottomPos }}>
      {isOpen && (
        <div className="nfc-window glass-panel-elevated" style={{ height: '500px', display: 'flex', flexDirection: 'column', position: 'relative', padding: 0 }}>
          ...
          <div className="nfc-messages" style={{ flex: '1 1 0%', minHeight: 0, overflowY: 'auto' }}>
            {messages.map((msg) => (
          ...
          <form className="nfc-input-form" style={{ margin: 0, marginTop: 'auto', boxSizing: 'border-box' }} onSubmit={handleSend}>
            <input 
              type="text" 
